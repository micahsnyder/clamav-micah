...
- `CERTS_DIRECTORY`: Customize the ClamAV CA certificates directory, may be relative.
...
cmake .. \
    ...
    -D CERTS_DIRECTORY=/etc/clamav/certs \
...
- `CERTS_DIRECTORY`: ClamAV CA certificates directory.
  Relative to the `CMAKE_INSTALL_PREFIX` unless an absolute path is given.
